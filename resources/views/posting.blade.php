                                                            ...
                                                            <div class="card-body cardContent">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12 column-input">
                                                                        <textarea class="card-text" name="inpDeskripsi"
                                                                            id="inpDeskripsi"
                                                                            placeholder="Deskripsi postingan"></textarea>
                                                                        <label for="btnUbahProfile">
                                                                            <img id="isiGambar" src="images/noImages.png" alt="Pilih gambar"
                                                                                style="width: 100%;">
                                                                            <input type="file" name="InpImagePostingan"
                                                                                id="btnUbahProfile">
                                                                        </label>
                                                                        <hr
                                                                    ...
                                                                    <div class="col-12">
                                                                        <input type="submit" name="posting" id="post"
                                                                            value="Posting">
                                                                    </div>
                                                                </div>
                                                            </div>
