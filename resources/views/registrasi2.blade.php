        ...
        <form action="{{ route('registrasi') }}" method="post">
          @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" id="form-name" placeholder="name@example.com">
            </div>
            <div class="mb-3">
                <label for="form-username" class="form-label">username </label>
                <input type="text" name="username" class="form-control" id="form-username" placeholder="name@example.com">
            </div>
            <div class="mb-3">
                <label for="form-email" class="form-label">Email </label>
                <input type="email" name="email" class="form-control" id="form-email" placeholder="name@example.com">
            </div>
            <div class="mb-3">
