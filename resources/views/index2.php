...
<body>
        ...
        <ul class="link-navigasi">
            ...
            <li>
                <a href="home.php">
                    ...
                    <p class="links_name" class="aktif">Posting</p>
                </a>
            </li>
            <li>
    ...
    <!-- <h1 style="transform: translateX(5rem); padding-top: 20px; margin-bottom: -0.4rem; letter-spacing: 3; color: var(--main_color-3); font-weight: 800;">Sosmed</h1> -->
    <section class="nav-section" style="z-index: 99; position: fixed;">
        <div class="container-fluid nav" style="background-color: white; ">
            <div class="container">
                <nav class="justify-content-center">
                    <div class="logoHomepage">
                        <img src="images/onedex.png" alt="logo homepage">
                    </div>
                    <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="container container-lg">
                                                    ...
                                                    <div class="card mx-auto">
                                                        <div class="card-body cardContent">
                                                            <div class="profileAuthor">
                                                                <a href="profile.php" style="display: flex; text-decoration: none;">
                                                                    <img class="imagesProfileAuthorPost" src="images/ldks-hari--1_1640302800_ldks-11-hari-1-thumb.jpg" alt="gambar profile">
                                                                    <div class="container" style="margin: 0rem 0rem 0rem -1.2rem;">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <p id="UsernamePosting">Naufal Fadhilah F</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                            ...
                                                            <form action="" method="POST">
                                                                <button class="saveToBookmark" type="submit" name="saveToBookmark">
                                                                    <i class="fa-regular fa-bookmark"></i>
                                                                </button>
                                                            </form>
                                                        </div>
                                                        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tenetur, fugiat accusantium inventore corrupti, culpa nobis nostrum accusamus magnam cum a odit sit laborum veniam repudiandae hic ducimus ipsam nulla sapiente ea voluptatum fuga voluptas reiciendis ex officiis? Temporibus, laborum quos reiciendis tenetur ullam dolore obcaecati neque hic voluptatem nemo quaerat quo eligendi quisquam laudantium, consequuntur sequi optio animi voluptate aspernatur nobis ipsa amet! Ea, molestias architecto? Reprehenderit tempora quo, at ipsam quam eveniet? Repellendus eos neque hic quibusdam veniam necessitatibus accusamus minima eius, animi natus magni ducimus eligendi assumenda voluptatem quos beatae eaque iusto et porro itaque voluptates reprehenderit. Minus?</p>
                                                        <img style="border-radius: 8px;" src="images/peringatan-hari-guru-2021_1640300572_hari-guru-21-thumb.jpg" class="card-img-top" alt="Gambar Postingan">
                                                        <hr style="color: var(--main_color-3); width: 100%; margin-top: 20px; height: 2px; justify-content: center;">
                                                        <div class="container fiturPostingan d-flex" style="margin-left: -4rem; font-size: 1rem;">
                                                            <i class="fa-regular fa-heart" style="margin-left: 45px; color: var(--main_color-3)"></i>
                                                            <p style="margin: 2px 0px 10px 8px; color: var(--main_color-3) ">5000</p>
                                                            <i class="fa-regular fa-comment" style="margin-left: 45px; color: var(--main_color-3)"></i>
                                                            <p style="margin: 2px 0px 10px 8px; color: var(--main_color-3);">100</p>
                                                            <i class="fa-regular fa-paper-plane" style="margin-left: 45px; color: var(--main_color-3)"></i>
                                                            <p style="margin: 2px 0px 10px 8px; color: var(--main_color-3);">20</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <a href="card.php" style="text-decoration: none; color: black;">
                                <div class="row" style="margin-bottom: 2rem;">
                                    <div class="col-12">
                                        <div class="konten-home">
                                            <div class="row">
                                                <div class="container-fluid">
                                                    <div class="card mx-auto">
                                                        <div class="card-body cardContent">
                                                            <div class="profileAuthor">
                                                                <a href="profile.php" style="display: flex; text-decoration: none;">
                                                                    <img class="imagesProfileAuthorPost" src="images/onedex.png" alt="gambar profile">
                                                                    <div class="container" style="margin: 0rem 0rem 0rem -1.2rem;">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <p id="UsernamePosting">Naufal Fadhilah F</p>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <p id="timePosting">2 jam yang lalu</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                        ...
                                                        <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint possimus amet iusto sunt cupiditate recusandae laudantium sit incidunt optio sed!</p>
                                                        <img style="border-radius: 8px;" src="images/sambut_pagi.jpg" class="card-img-top" alt="Gambar Postingan">
                                                        <hr style="color: var(--main_color-3); width: 100%; margin-top: 20px; height: 2px; justify-content: center;">
                                                        <div class="container fiturPostingan d-flex" style="margin-left: -4rem; font-size: 1rem;">
                                                            <i class="fa-regular fa-heart" style="margin-left: 45px; color: var(--main_color-3)"></i>
                                                            <p style="margin: 2px 0px 10px 8px; color: var(--main_color-3) ">5000</p>
                    ...
                    <div class="col-3">
                        <div class="row" style="position: fixed; max-width: 20rem; margin-left: -2rem;">
                            <div class="col-12" id="SuggestFollowing">
                                <div class="container" style="height: 50rem; width: 120%; margin-left: -3rem;">
                                    <div class="row">
                                        <div class="col-12">
                                            <p style="font-size: 0.7rem; font-family: 'Poppins'; font-weight: 600; color: grey; margin-top: 1rem;">
                                    ...
                                    <div class="row" style="max-height: 7rem; margin-bottom: 0.7rem;">
                                        <div class="row">
                                            <a href="index.php" style="text-decoration: none; display:flex; color: black;">
                                                <div class="col-1">
                                                ...
                                                <div class="col-3">
                                                    <form action="" method="POST">
                                                        <p>
                                                            <input type="submit" class="btn" name="follow" id="follow" value="Follow" style="font-weight: 700; margin-top: 7px; font-size: 0.7rem; color: var(--main_color-3); ">
                                                        </p>
                                                    </form>
                                                </div>
                                            </a>
