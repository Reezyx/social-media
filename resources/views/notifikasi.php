                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <p class="usernameDetailFollow"
                                        style="text-align: center; justify-content: center;">Notifikasi</p>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="container listFollowersSearch" style="max-width: 37rem; margin-top: 1rem;">
                            <div class="col-12 listFollowers">
                                ...
                                <a href="profile.php" style="display: flex; margin-bottom: 1rem;">
                                    <img src="images/sambut_pagi.jpg" alt="gambar postingan">
                                    <div class="container-fluid d-flex mt-2">
                                        <p class="usernameFollowers">Naufal Fadhilah F</p>
                                ...
                                <a href="profile.php" style="display: flex; margin-bottom: 1rem;">
                                    <img src="images/sambut_pagi.jpg" alt="gambar postingan">
                                    <div class="container-fluid d-flex mt-2">
                                        <p class="usernameFollowers">Nozzents</p>
                                        <p class="namaFollowers">Menyukai postingan anda</p>
                                    </div>
                                    <img src="images/usbn.jpg" alt="gambar postingan" style="border-radius: 0px;">
                                </a>
                                <a href="profile.php" style="display: flex; margin-bottom: 1rem;">
                                    <img src="images/usbn.jpg" alt="gambar postingan">
                                    <div class="container-fluid d-flex mt-2">
                                        <p class="usernameFollowers">Daridar</p>
