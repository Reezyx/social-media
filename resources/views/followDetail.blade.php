                ...
                <div class="row">
                        ...
                        <div class="row navigasiFilter">
                            <ul class="navigasi" style="margin-top: 10px; margin-bottom: -20px;">
                                <li class="navigasi-item NavFilter">
                                    <a class="navigasi-link kategoriFollow"
                                        href="{{ route('seeFollower', ['user' => $user->id]) }}">
                                        <p>Followers</p>
                                    </a>
                                </li>
                                <li class="navigasi-item">
                                    <a class="navigasi-link kategoriFollow"
                                        href="{{ route('seeFollowing', ['user' => $user->id]) }}">
                                        <p>Following</p>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="col-lg-6 listFollowersSearch">
                        ...
                        @foreach ($follows as $follow)
                            <a href="{{ route('seePeople', ['user' => $follow->follower->id]) }}"
                                style="display: flex;">
                                <i><img src="{{ $follow->follower->image }}" alt="gambar postingan"></i>
                                <div class="container-fluid">
                                    <div class="row">
                                        <span class="usernameFollowers">{{ $follow->follower->username }}</span>
                                    </div>
                                    <div class="row">
                                        <span class="namaFollowers">{{ $follow->follower->name }}</span>
                                    </div>
                                </div>
                                <form action="" method="POST">
                                    <p>
...
<script>
    ...
    $(document).ready(function() {
        $('.kategoriFollow').on('click', function(event) {
            if (window.location.href.indexOf('seeFollower') > -1) {
                $('.kategoriFollow').removeClass('active');
