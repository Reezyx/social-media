    ...
    <div class="container-fluid" style="background-color: var(--main_color); min-height: 100%; margin-bottom: 10vh; ">
        <form action="" method="POST">
            <div class="container-fluid" style="padding: 5% 10%;">
                <div class="row" style="margin-top: 5%;  margin-bottom: 6vh">
                    <div class="col-12">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <input type="text" name="username" id="username" placeholder="Masukkan username" style="border-radius: 10px; width: 100%; font-size: 0.8rem; padding: 8px 20px 8px 15px; letter-spacing: 0.7; box-shadow: 2px 5px 25px rgba(0, 0, 0, 0.2); border: transparent;">
                                        </div>
                                        <div class="row">
                                            <h6 style="color: white; font-family: 'Poppins'; margin-left: -10px; margin-top: 20px; letter-spacing: 1;">
                                                Password
                                            </h6>
                                            <input type="password" name="password" id="password" placeholder="Masukkan password" style="border-radius: 10px; width: 100%; font-size: 0.8rem; padding: 8px 20px 8px 15px; letter-spacing: 0.7; box-shadow: 2px 5px 25px rgba(0, 0, 0, 0.2); border: transparent;">
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="submit" name="login" value="Login" id="submit" style="border-radius: 5px; margin-top: 30px; background-color: white; color: var(--main_color); border: 2px; font-family: 'Poppins'; float: right; box-shadow: 2px 5px 25px rgba(0, 0, 0, 0.2); width: 20%; font-size: 0.8rem; margin-right: -15px; padding: 8px 20px 8px 15px;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style=" margin-top: 3rem;">
                                    <div class="col-12 d-flex" style="justify-content: center; ">
                                        <p style="font-size: 0.8rem; color: white; margin-right: 5px; font-weight: 600;">Belum punya akun?</p>
                                        <p style="font-size: 0.8rem; color: white;"><a href="#" class="btnRegist" style="color: white; border: 2px; font-family: 'Poppins';">Register</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
