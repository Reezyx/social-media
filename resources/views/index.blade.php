    ...
    <div class="sidebar">
        <div class="detail_logo">
            <a href="{{ route('myProfile') }}" style="display: flex;">
                <i><img src="{{ $user->image }}" alt="gambar postingan"></i>
        ...
        <div class="container-fluid nav" style="background-color: black;">
            <div class="container-fluid container-xl">
                <div class="row">
                                                            ...
                                                            <div class="card-body cardContent">
                                                                ...
                                                                <form
                                                                    ...
                                                                    <button class="saveToBookmark" type="submit"
                                                                        name="saveToBookmark">
                                                                        {!! $post->is_bookmark ? '<i class="fa-solid fa-bookmark"></i>' : '<i class="fa-regular fa-bookmark"></i>' !!}
                                                                    </button>
                    ...
                    <div class="col-3">
                        <div class="row" style="position: fixed; margin-left: -3rem;">
                            <div class="col-12" id="SuggestFollowing">
                                <div class="container"
                                    style="max-height: 50rem; overflow: auto; width: 100%; margin-left: -3rem;">
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row"
                                        style="max-height: 15rem; overflow: auto; margin-bottom: 0.7rem;">
                                        @foreach ($others as $suggested)
                                            <div class="row">
                                                <a href="{{ route('myProfile') }}"
                                                    ...
                                                    <div class="col-3">
                                                        <form
                                                            action="{{ route('follow', ['people' => $suggested->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            <p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-12 d-flex column-btn">
                <a href="{{ route('formLogin') }}" class="btn btn-login-footer">Login</a>
                <a href="{{ route('formRegistrasi') }}" class="btn btn-regist-footer">Register</a>
            </div>
        </div>
</footer>
</div>
