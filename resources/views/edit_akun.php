                                        ...
                                        <div class="col-xl-12">
                                            <div class="container">
                                                <div class="col-12">
                                                    <div class="col-12 fotoProfile text-center">
                                                        ...
                                                        <label for="btnUbahProfile">
                                                            ...
                                                            <input type="file" name="edtFotoProfile"
                                                                id="btnUbahProfile">
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p><input type="text" name="inpUsername" id="inpUsername"
                                                                value="jangandifollow_74"></p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p><input type="text" name="inpNama" id="inpNama"
                                                                value="Naufal Fadhilah F"></p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p><input type="text" name="inpEmail" id="inpEmail"
                                                                value="naufalfadhilahxpplg1@gmail.com"></p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3">
